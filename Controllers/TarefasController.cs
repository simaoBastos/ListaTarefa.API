...
public class TarefasController : ControllerBase
{
    ...
    [HttpPatch("{id}")]
    public IActionResult AtualizarTarefa(int id, TarefaPatchDto patch)
    {
        if (patch.Titulo == null && patch.Descricao == null && patch.Concluido == null)
            return BadRequest("Informe pelo menos um campo para atualizar.");
        ...
        tarefa.Titulo = patch.Titulo ?? tarefa.Titulo;
        tarefa.Descricao = patch.Descricao ?? tarefa.Descricao;
        tarefa.Concluido = patch.Concluido ?? tarefa.Concluido;
        ...
        updateCommand.Parameters.AddWithValue("@Titulo", tarefa.Titulo);
        updateCommand.Parameters.AddWithValue("@Descricao", tarefa.Descricao);
        updateCommand.Parameters.AddWithValue("@Concluido", tarefa.Concluido);
